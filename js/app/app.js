...
aplicacion.controller('AppCtrl', [
    '$scope',"$rootScope"
    , '$mdBottomSheet','$mdSidenav', 'UserModel', 'SolicitudModel', 'Modules', '$mdDialog', '$mdMedia', '$mdToast', 'NotificacionesModel' , '$q', 'Config',
                    ...
                    function(){
                        if(angular.isUndefined(usuario.id)){
                            ...
                            var dataSolicitud = SolicitudModel.get({id_user:usuario.id}, function(){
                                ...
                                $rootScope.menub = Modules.getMenu($scope.user.role);
                                ...
                                $scope.masterMenus[0].items.push($rootScope.menub.notificaciones);
                                $scope.masterMenus[0].items.push($rootScope.menub.mensajes);
                                

                                $scope.masterMenus[1].items.push($rootScope.menub.solicitud);
                                $scope.masterMenus[1].items.push($rootScope.menub.documentos);
                                $scope.masterMenus[1].items.push($rootScope.menub.credito);
                                $scope.masterMenus[1].items.push($rootScope.menub.buro);
                                
                                $scope.masterMenus[1].items.push($rootScope.menub.saldo);
                                $scope.masterMenus[1].items.push($scope.menub.calculadora);



                                $scope.masterMenus[2].items.push($rootScope.menub.config);
